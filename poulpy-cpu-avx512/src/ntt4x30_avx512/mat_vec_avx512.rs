    ...
    unsafe {
        ...
        for p in 0..4usize {
            ...
            for row in 0..ell {
                ...
                let y = _mm512_permutexvar_epi64(duplicate_idx, _mm512_castsi256_si512(_mm256_loadu_si256(y_ptr.add(row))));
                let prod_lo = _mm512_mul_epu32(_mm512_and_si512(x, mask32), _mm512_and_si512(y, mask32));
                let prod_hi = _mm512_mul_epu32(_mm512_srli_epi64::<32>(x), _mm512_srli_epi64::<32>(y));
                lo = _mm512_add_epi64(lo, _mm512_and_si512(prod_lo, mask32));
                lo = _mm512_add_epi64(lo, _mm512_and_si512(prod_hi, mask32));
                hi = _mm512_add_epi64(hi, _mm512_srli_epi64::<32>(prod_lo));
                hi = _mm512_add_epi64(hi, _mm512_srli_epi64::<32>(prod_hi));
            }
