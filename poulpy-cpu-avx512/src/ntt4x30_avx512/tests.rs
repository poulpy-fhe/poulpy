...
fn test_vmp_pmat_packed_byte_size() {
    ...
    assert_eq!(
        <NTT4x30Avx512 as Backend>::bytes_of_vmp_pmat(n, rows, cols_in, cols_out, size, PrepareHint::Reuse),
...
fn test_transform_domain_packed_byte_sizes() {
    ...
    assert_eq!(<NTT4x30Avx512 as Backend>::bytes_of_vec_znx_dft(n, cols, size), packed_bytes);
    assert_eq!(
        <NTT4x30Avx512 as Backend>::bytes_of_cnv_pvec_left(n, cols, size, PrepareHint::Reuse),
        packed_bytes
    );
    assert_eq!(
        <NTT4x30Avx512 as Backend>::bytes_of_cnv_pvec_right(n, cols, size, PrepareHint::Reuse),
        packed_bytes
    );
    assert_eq!(
        <NTT4x30Avx512 as Backend>::bytes_of_svp_ppol(n, cols, PrepareHint::Reuse),
...
fn test_convolution_direct() {
    ...
    const FLOOR: usize = <NTT4x30Avx512 as poulpy_hal::layouts::Backend>::MIN_DEGREE;
...
fn large_ring_ntt_log17() {
    poulpy_cpu_ref::test_suite::ntt::test_ntt_ring_degree::<crate::NTT4x30Avx512>(1 << 17, 50);
}

#[cfg(feature = "enable-rayon")]
#[test]
fn large_ring_ntt_rayon_log17() {
    poulpy_cpu_ref::test_suite::ntt::test_ntt_ring_degree::<crate::NTT4x30Avx512Rayon>(1 << 17, 50);
}

#[test]
fn large_ring_ntt_log18() {
    poulpy_cpu_ref::test_suite::ntt::test_ntt_ring_degree::<crate::NTT4x30Avx512>(1 << 18, 50);
}

#[cfg(feature = "enable-rayon")]
#[test]
fn large_ring_ntt_rayon_log18() {
    poulpy_cpu_ref::test_suite::ntt::test_ntt_ring_degree::<crate::NTT4x30Avx512Rayon>(1 << 18, 50);
}
