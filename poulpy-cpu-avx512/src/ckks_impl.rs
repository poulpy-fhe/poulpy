...
impl_ckks_dft_defaults!(NTT120Avx512);
#[cfg(feature = "enable-ifma")]
impl_ckks_dft_defaults!(NTT126Ifma);

impl_ckks_bootstrapping_defaults!(FFT64Avx512);
impl_ckks_bootstrapping_defaults!(NTT120Avx512);
#[cfg(feature = "enable-ifma")]
impl_ckks_bootstrapping_defaults!(NTT126Ifma);
