...
poulpy_cpu_portable::impl_sampling_host!(FFT64Avx512, fft64);
impl_encryption_defaults_full!(NTT4x30Avx512);
poulpy_cpu_portable::impl_sampling_host!(NTT4x30Avx512, ntt4x30);
#[cfg(feature = "enable-ifma")]
impl_encryption_defaults_full!(NTT3x42Ifma);
#[cfg(feature = "enable-ifma")]
poulpy_cpu_portable::impl_sampling_host!(NTT3x42Ifma, ntt4x30);
...
#[cfg(feature = "enable-rayon")]
poulpy_cpu_portable::impl_sampling_host!(FFT64Avx512Rayon, fft64);
#[cfg(feature = "enable-rayon")]
...
mod ntt4x30_rayon_defaults {
    ...
    poulpy_cpu_portable::impl_sampling_host!(NTT4x30Avx512Rayon, ntt4x30);
