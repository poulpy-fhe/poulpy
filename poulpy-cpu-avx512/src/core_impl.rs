...
impl_glwe_keyswitch_into_big_defaults_full!(FFT64Avx512);
impl_glwe_keyswitch_into_big_defaults_full!(NTT4x30Avx512);
#[cfg(feature = "enable-ifma")]
impl_glwe_keyswitch_into_big_defaults_full!(NTT3x42Ifma);

impl_glwe_finalize_big_defaults_full!(FFT64Avx512);
impl_glwe_finalize_big_defaults_full!(NTT4x30Avx512);
#[cfg(feature = "enable-ifma")]
impl_glwe_finalize_big_defaults_full!(NTT3x42Ifma);
