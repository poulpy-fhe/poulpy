//! Large-coefficient (i128) ring element vector support for [`NTT126Ifma`](super::NTT126Ifma).
//!
...
//! live in [`crate::vec_znx_big_avx512`] and are shared with [`NTT120Avx512`](crate::NTT120Avx512):
...
impl I128BigOps for NTT126Ifma {
    ...
    fn i128_add(res: &mut [i128], a: &[i128], b: &[i128]) {
        // SAFETY: NTT126Ifma::new() verifies AVX-512F availability at construction time.
...
impl ScalarBigHadamardProduct for NTT126Ifma {
    #[inline(always)]
