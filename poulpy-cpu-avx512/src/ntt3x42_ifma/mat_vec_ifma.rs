...
//! layout as the input prep scalar. This differs from the AVX/NTT4x30 prepared
//! format, which uses
...
mod tests {
    ...
    use crate::ntt3x42_ifma::{
        ...
        primes::Primes42,
        reference::{
            arithmetic::{b_ntt3x42_ifma_from_znx64_ref, c_ntt3x42_ifma_from_b_ref},
            mat_vec::{
                vec_mat1col_product_bbc_ntt3x42_ifma_ref, vec_mat1col_product_x2_bbc_ntt3x42_ifma_ref,
                vec_mat2cols_product_x2_bbc_ntt3x42_ifma_ref,
            },
        },
    };
    ...
    fn make_prep_u32(count: usize, seed: i64) -> Vec<u32> {
        ...
        b_ntt3x42_ifma_from_znx64_ref(count, &mut b, &coeffs);
    ...
    fn make_prepared_u32(count: usize, seed: i64) -> Vec<u32> {
        ...
        c_ntt3x42_ifma_from_b_ref(count, &mut c, &b);
        c
    }
