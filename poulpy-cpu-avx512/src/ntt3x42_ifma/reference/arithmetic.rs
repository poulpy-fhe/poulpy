...
//!
//! Provides:
//! - `b_ntt3x42_ifma_from_znx64_ref`: i64 → 3-prime CRT (three `n`-coefficient planes)
//! - `b_ntt3x42_ifma_to_znx128_ref`: 3-prime CRT → i128 via Garner's algorithm
//! - `c_ntt3x42_ifma_from_b_ref`: b → prepared c format (Harvey quotient pairs)
...
mod tests {
    ...
    fn b_from_znx64_roundtrip() {
        ...
        b_ntt3x42_ifma_from_znx64_ref(n, &mut b, &coeffs);

        let mut result = vec![0i128; n];
        b_ntt3x42_ifma_to_znx128_ref(n, &mut result, &b);
