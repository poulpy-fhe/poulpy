...
pub fn vec_mat1col_product_bbc_ntt3x42_ifma_ref(
...
pub fn vec_mat1col_product_x2_bbc_ntt3x42_ifma_ref(
    _meta: &Bbc126IfmaMeta<Primes42>,
    ell: usize,
    res: &mut [u64],
    x: &[u32],
...
pub fn vec_mat2cols_product_x2_bbc_ntt3x42_ifma_ref(
    _meta: &Bbc126IfmaMeta<Primes42>,
    ell: usize,
    res: &mut [u64],
    x: &[u32],
...
pub fn extract_1blk_from_contiguous_ntt3x42_ifma_ref(n: usize, row_max: usize, blk: usize, dst: &mut [u64], src: &[u64]) {
