...
use super::super::primes::PrimeSetNtt3x42Ifma;
use super::super::tables::{Ntt3x42IfmaTable, Ntt3x42IfmaTableInv, cond_sub_2q, harvey_modmul};
...
mod tests {
    ...
    fn ntt_intt_identity() {
        for log_n in 1..=10usize {
            ...
            intt3x42_ifma_ref::<Primes42>(&inv, &mut data);
    ...
    fn ntt_convolution() {
        ...
        b_ntt3x42_ifma_from_znx64_ref(n, &mut da, &a);
        b_ntt3x42_ifma_from_znx64_ref(n, &mut db, &b);

        ntt3x42_ifma_ref::<Primes42>(&fwd, &mut da);
        ntt3x42_ifma_ref::<Primes42>(&fwd, &mut db);
        ...
        intt3x42_ifma_ref::<Primes42>(&inv, &mut dc);
