...
/// domain     res: a dense VecZnx; base2k in 1..=62 (independent of Module::max_base2k, which bounds scheme/product parameters); 0 < k <= res.size() * base2k; source: the caller's pseudorandom stream
