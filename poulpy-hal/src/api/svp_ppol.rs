...
/// domain     res: an SvpPPol; a: a ScalarZnx of degree N
...
/// domain     res: a VecZnxDft; a: an SvpPPol; b: a dense VecZnx; all operands have the degree N of the call
...
/// domain     res, b: VecZnxDft; a: an SvpPPol; all operands have the degree N of the call
/// ensures    the selected source limbs are multiplied by the prepared scalar polynomial; result limbs from b.size() onward are zero
/// test       test_svp_apply_dft_to_dft
/// ```
...
/// domain     res: a VecZnxDft; a: an SvpPPol; both operands have the degree N of the call
