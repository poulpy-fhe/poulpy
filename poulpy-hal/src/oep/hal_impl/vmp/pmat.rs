...
pub unsafe trait HalVmpPMatImpl<BE: Backend>: Backend {
    fn vmp_prepare_pmat_tmp_bytes(module: &Module<BE>, rows: usize, cols_in: usize, cols_out: usize, size: usize) -> usize;
    fn vmp_prepare_pmat(
        module: &Module<BE>,
