...
use super::helpers::{
    ...
    assert_decrypt_precision_at_log_delta, ckks_encrypt, ckks_encrypt_with_prec, ckks_spec, gen_sk_with_raw, gen_tsk,
    precision_at, quantized_const, quantized_slots, test_vector_1, upload_pt,
};
    ...
    E: NegacyclicFFT<F>,
{
    let degree = 31usize;
    let drop = 3usize;
    let coeff_meta = ckks_spec(params.n, params.base2k, 20, 8);
    ...
    E: NegacyclicFFT<F> + NegacyclicFFTNew<F>,
{
    ...
    let coeff_meta = ckks_spec(params.n, params.base2k, log_delta, 8);
