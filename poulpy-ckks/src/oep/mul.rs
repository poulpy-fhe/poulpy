...
use crate::{CKKSInfos, GLWEToBackendMut, GLWEToBackendRef, SetCKKSInfos, layouts::CKKSPreparedRight};
...
pub unsafe trait CKKSMulImpl<BE: Backend>: Backend {
    ...
    fn ckks_mul_pt_vec_tmp_bytes<R: GLWEInfos, A: GLWEInfos>(module: &Module<BE>, res: &R, a: &A, b_k: TorusPrecision) -> usize;
    fn ckks_mul_pt_const_tmp_bytes<R: GLWEInfos, A: GLWEInfos>(module: &Module<BE>, res: &R, a: &A, b_k: TorusPrecision)
    -> usize;
        ...
        + VecZnxCopyBackend<BE>,
{
    ...
    fn ckks_mul_pt_const_tmp_bytes<R: GLWEInfos, A: GLWEInfos>(
        module: &Module<BE>,
        res: &R,
        a: &A,
        b_k: TorusPrecision,
