...
use poulpy_core::{
    GLWECopy,
    layouts::{
        BSGSMeta, Base2K, Degree, GGLWEInfos, GLWEInfos, GLWELayout, GLWEToBackendMut, GLWEToBackendRef, LWEInfos, Rank,
        SetBSGSMeta, TorusPrecision, prepared::GLWETensorKeyPreparedToBackendRef,
    },
};
...
pub fn ckks_eval_mod_tmp_bytes_default<BE, R, C, P, F, H>(
    module: &Module<BE>,
    res: &R,
    ct: &C,
    params: &EvalMod<F, P>,
