use poulpy_core::{
    ...
    layouts::{
        Base2K, GGLWEInfos, GGLWEPreparedToBackendRef, GLWE, GLWEAutomorphismKeyHelper, GLWEAutomorphismKeyLayoutHelper,
        GLWEInfos, GLWEPlaintext, GLWEPlaintextLayout, GLWESecretPreparedToBackendRef, GLWEToBackendMut, GLWEToBackendRef,
        GetGaloisElement, LWEInfos, LWEToBackendMut, ModuleCoreAlloc, Rank, TorusPrecision,
    },
};
...
impl<D: HostDataMut, T: UnsignedInteger> FheUint<D, T, i64> {
        ...
        for<'a> BE::BufMut<'a>: HostDataMut,
    {
        ...
        for i in 0..3 {
            let mut tmp: GLWE<BE::OwnedBuf, BE::ZnxWord> = module.glwe_alloc_from_infos(self);
