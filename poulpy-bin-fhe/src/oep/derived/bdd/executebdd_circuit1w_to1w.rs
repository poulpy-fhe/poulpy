...
pub(crate) fn execute_bdd_circuit_1w_to_1w_derived<BE, C, H, T>(
    module: &Module<BE>,
...
pub(crate) fn execute_bdd_circuit_1w_to_1w_tmp_bytes_derived<BE, C, T, R, G, H>(
    module: &Module<BE>,
    circuit: &C,
    res_infos: &R,
    ggsw_infos: &G,
...
where
    ...
    Module<BE>: ExecuteBDDCircuit1WTo1W<BE>,
{
    module.execute_bdd_circuit_1w_to_1w_multi_thread_tmp_bytes::<C, T, R, G, H>(1, circuit, res_infos, ggsw_infos, key)
}
