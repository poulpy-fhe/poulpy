...
pub fn test_blind_rotation<BRA: BlindRotationAlgo, M, BE: Backend<OwnedBuf = AlignedBuf, ZnxWord = i64>>(
    module: &M,
    n_lwe: usize,
    block_size: usize,
    ...
    for<'a> BE::BufRef<'a>: HostDataRef,
{
    ...
    let mut brk: BlindRotationKey<BE::OwnedBuf, BRA, BE::ZnxWord> =
        BlindRotationKey::<AlignedBuf, BRA, i64>::alloc(module, &brk_infos);
    ...
    let mut pt_lwe: LWEPlaintext<AlignedBuf, i64> = module.lwe_plaintext_alloc_from_infos(&lwe_infos);
