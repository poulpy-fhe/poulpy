...
use poulpy_core::{
    ...
    layouts::{
        GLWE, GLWELayout, GLWEPlaintext, GLWEPublicKey, GLWEPublicKeyPrepared, GLWEPublicKeyPreparedFactory,
        GLWESecretPreparedFactory, GLWESecretSampling, LWEInfos, ModuleCoreAlloc,
    },
};
use poulpy_hal::{
    AlignedBuf,
    ...
    ScratchOwned<BE>: ScratchOwnedAlloc<BE> + ScratchOwnedBorrow<BE>,
{
    ...
    // Encryption under a public key of the ideal secret: the key error is the sum
    // of the parties' errors, and each secret coefficient has variance PARTIES / 2.
