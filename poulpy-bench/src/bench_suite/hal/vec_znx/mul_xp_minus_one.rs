...
pub fn bench_vec_znx_mul_xp_minus_one<B: Backend<ZnxWord = i64>>(c: &mut Criterion, label: &str)
where
...
pub fn bench_vec_znx_mul_xp_minus_one_assign<B: Backend<ZnxWord = i64>>(c: &mut Criterion, label: &str)
where
