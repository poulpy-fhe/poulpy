...
pub fn bench_vec_znx_rotate<B: Backend<ZnxWord = i64>>(c: &mut Criterion, label: &str)
where
...
pub fn bench_vec_znx_rotate_assign<B: Backend<ZnxWord = i64>>(c: &mut Criterion, label: &str)
where
