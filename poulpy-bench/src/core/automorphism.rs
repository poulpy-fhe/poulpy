use poulpy_core::{
    ...
    layouts::{
        Base2K, Degree, Dnum, Dsize, GGLWEInfos, GLWE, GLWEAutomorphismKey, GLWEAutomorphismKeyLayout, GLWELayout, GLWESecret,
...
pub fn runner_glwe_automorphism<BE: Backend<OwnedBuf = Vec<u8>>, M: Measurement>(
