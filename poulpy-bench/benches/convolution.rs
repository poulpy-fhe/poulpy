...
fn bench_cnv_apply_dft_accumulate(c: &mut Criterion) {
    poulpy_bench::for_each_backend!(poulpy_bench::bench_suite::hal::convolution::bench_cnv_apply_dft_accumulate, &poulpy_bench::params::BenchParams::get().cnv; c);
}
...
criterion_group! {
    ...
    bench_cnv_apply_dft,
    bench_cnv_apply_dft_accumulate,
