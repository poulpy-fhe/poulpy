...
fn bench_vec_znx_dft_sub_assign(c: &mut Criterion) {
    poulpy_bench::for_each_backend!(poulpy_bench::bench_suite::hal::vec_znx_dft::bench_vec_znx_dft_sub_assign, &poulpy_bench::params::BenchParams::get().hal; c);
}
fn bench_vec_znx_dft_sub_negate_assign(c: &mut Criterion) {
    poulpy_bench::for_each_backend!(poulpy_bench::bench_suite::hal::vec_znx_dft::bench_vec_znx_dft_sub_negate_assign, &poulpy_bench::params::BenchParams::get().hal; c);
}
