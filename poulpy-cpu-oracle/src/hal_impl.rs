...
unsafe impl HalVmpImpl for FFT64Oracle {
    hal_impl_vmp!(FFT64VmpDefault);
}

unsafe impl HalConvolutionImpl for FFT64Oracle {
...
unsafe impl HalSvpImpl for FFT64Oracle {
...
unsafe impl HalVmpImpl for NTT4x30Oracle {
    hal_impl_vmp!(NTT4x30VmpDefault);
}

unsafe impl HalConvolutionImpl for NTT4x30Oracle {
...
unsafe impl HalSvpImpl for NTT4x30Oracle {
