...
impl_ckks_encapsulated_mod_up_default!(FFT64Oracle);
impl_ckks_encapsulated_mod_up_default!(NTT4x30Oracle);
impl_ckks_conjugate_defaults!(FFT64Oracle);
impl_ckks_conjugate_defaults!(NTT4x30Oracle);
impl_ckks_copy_defaults!(FFT64Oracle);
impl_ckks_copy_defaults!(NTT4x30Oracle);
impl_ckks_encryption_defaults!(FFT64Oracle);
impl_ckks_encryption_defaults!(NTT4x30Oracle);
impl_ckks_imag_defaults!(FFT64Oracle);
impl_ckks_imag_defaults!(NTT4x30Oracle);
impl_ckks_mul_defaults!(FFT64Oracle);
impl_ckks_mul_defaults!(NTT4x30Oracle);
impl_ckks_neg_defaults!(FFT64Oracle);
impl_ckks_neg_defaults!(NTT4x30Oracle);
impl_ckks_pow2_defaults!(FFT64Oracle);
impl_ckks_pow2_defaults!(NTT4x30Oracle);
impl_ckks_rotate_defaults!(FFT64Oracle);
impl_ckks_rotate_defaults!(NTT4x30Oracle);
// The reference backends have no accelerated transform, so they select the
// generic scalar table for every precision at once.
impl<F> crate::ckks_encoding::CKKSEncodingTransform<F> for FFT64Oracle
where
...
impl_ckks_sub_defaults!(NTT4x30Oracle);
impl_ckks_plaintext_defaults!(FFT64Oracle);
impl_ckks_plaintext_defaults!(NTT4x30Oracle);
impl_ckks_dft_defaults!(FFT64Oracle);
impl_ckks_dft_defaults!(NTT4x30Oracle);
