...
/// `Module<FFT64Oracle>` is dropped (via [`Backend::destroy`]).
#[repr(C)]
pub struct FFT64OracleHandle {
    ring_plans: FFT64PlanSet<f64>,
    table_cache: crate::table_cache::ModuleTableCache,
}

impl poulpy_hal::execution::ScratchWorkers for FFT64Oracle {}

impl Backend for FFT64Oracle {
...
unsafe impl FFT64HandleFactory for FFT64OracleHandle {
...
unsafe impl FFTHandleProvider<f64> for FFT64OracleHandle {
    fn get_fft_plan(&self, n: usize) -> &FFT64Plan<f64> {
        self.ring_plans.for_ring(n)
    }
}

unsafe impl crate::table_cache::ModuleTableCacheProvider for FFT64OracleHandle {
