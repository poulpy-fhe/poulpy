//! Single ring element (`Z[X]/(X^n+1)`) arithmetic for [`FFT64Oracle`](crate::FFT64Oracle).
//!
...
impl ZnxMulAddPowerOfTwo for FFT64Oracle {
    #[inline(always)]
...
impl ZnxMulPowerOfTwo for FFT64Oracle {
    #[inline(always)]
...
impl ZnxMulPowerOfTwoAssign for FFT64Oracle {
    #[inline(always)]
...
impl ZnxAutomorphismRotate for FFT64Oracle {
    #[inline(always)]
...
impl ZnxNormalizeFirstStep for FFT64Oracle {
    #[inline(always)]
...
impl ZnxNormalizeMiddleStep for FFT64Oracle {
    #[inline(always)]
...
impl ZnxNormalizeFinalStep for FFT64Oracle {
    #[inline(always)]
...
impl ZnxNormalizeFinalStepAssign for FFT64Oracle {
    #[inline(always)]
...
impl ZnxNormalizeFirstStepCarryOnly for FFT64Oracle {
    #[inline(always)]
...
impl ZnxNormalizeFirstStepAssign for FFT64Oracle {
    #[inline(always)]
...
impl ZnxNormalizeMiddleStepCarryOnly for FFT64Oracle {
    #[inline(always)]
...
impl ZnxNormalizeMiddleStepAssign for FFT64Oracle {
    #[inline(always)]
...
impl ZnxExtractDigitAddMul for FFT64Oracle {
    #[inline(always)]
...
impl crate::reference::normalization::I64NormalizeOps for FFT64Oracle {}

impl ZnxNormalizeDigit for FFT64Oracle {
    #[inline(always)]
...
mod normalization_tests {
    ...
    fn test_normalization_kernels_bounded_inputs() {
        crate::test_suite::normalization::test_normalization_kernels::<crate::FFT64Oracle>();
        crate::test_suite::normalization::test_normalization_kernels::<crate::NTT4x30Oracle>();
    }
}
