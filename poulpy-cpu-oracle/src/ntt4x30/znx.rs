//! Single ring element (`Z[X]/(X^n+1)`) arithmetic for [`NTT4x30Oracle`](crate::NTT4x30Oracle).
//!
...
impl ZnxMulAddPowerOfTwo for NTT4x30Oracle {
    #[inline(always)]
...
impl ZnxMulPowerOfTwo for NTT4x30Oracle {
    #[inline(always)]
...
impl ZnxMulPowerOfTwoAssign for NTT4x30Oracle {
    #[inline(always)]
...
impl ZnxAutomorphismRotate for NTT4x30Oracle {
    #[inline(always)]
...
impl ZnxNormalizeFirstStep for NTT4x30Oracle {
    #[inline(always)]
...
impl ZnxNormalizeMiddleStep for NTT4x30Oracle {
    #[inline(always)]
...
impl ZnxNormalizeFinalStep for NTT4x30Oracle {
    #[inline(always)]
...
impl ZnxNormalizeFinalStepAssign for NTT4x30Oracle {
    #[inline(always)]
...
impl ZnxNormalizeFirstStepCarryOnly for NTT4x30Oracle {
    #[inline(always)]
...
impl ZnxNormalizeFirstStepAssign for NTT4x30Oracle {
    #[inline(always)]
...
impl ZnxNormalizeMiddleStepCarryOnly for NTT4x30Oracle {
    #[inline(always)]
...
impl ZnxNormalizeMiddleStepAssign for NTT4x30Oracle {
    #[inline(always)]
...
impl ZnxExtractDigitAddMul for NTT4x30Oracle {
    #[inline(always)]
...
impl crate::reference::normalization::I64NormalizeOps for NTT4x30Oracle {}

impl ZnxNormalizeDigit for NTT4x30Oracle {
    #[inline(always)]
