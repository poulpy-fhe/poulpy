...
//!
//! This module provides standalone reference functions for [`VecZnxBig`](poulpy_hal::layouts::VecZnxBig) operations
...
//! # Layout
//!
//! A `VecZnxBig<_, NTT4x30Oracle>` with `cols` columns, `size` limbs, and ring degree `n`
...
///
/// All methods have scalar default implementations.  `NTT4x30Oracle` and other
