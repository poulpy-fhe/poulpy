...
use crate::{FFT64Oracle, hal_impl::delegating_backend::DelegatingFFT64Oracle};
...
fn sample_glwe() -> GLWE<Vec<u8>, i64> {
    ...
    let module: Module<FFT64Oracle> = Module::new(256);
...
fn delegating_backend_manual_family_matches_fft64_ref() {
    let module_delegating: Module<DelegatingFFT64Oracle> = Module::new(256);
    let module_ref: Module<FFT64Oracle> = Module::new(256);
