...
macro_rules! hal_impl_vmp {
    ($defaults:ident) => {
        fn vmp_prepare_tmp_bytes(module: &Module<Self>, rows: usize, cols_in: usize, cols_out: usize, size: usize) -> usize {
            <Self as $defaults>::vmp_prepare_tmp_bytes_default(module, rows, cols_in, cols_out, size)
        }
        ...
        fn vmp_prepare(
            ...
            <Self as $defaults>::vmp_prepare_default(module, res, a, &mut scratch);
        }
        ...
        fn vmp_apply_dft_to_dft_tmp_bytes(
            ...
            <Self as $defaults>::vmp_apply_dft_to_dft_tmp_bytes_default(
        ...
        fn vmp_apply_dft_to_dft(
            ...
            let mut scratch = scratch.borrow();
            <Self as $defaults>::vmp_apply_dft_to_dft_default(module, res, a, b, limb_offset, &mut scratch);
        }
        ...
        fn vmp_extract_selected_rows(
            ...
            <Self as $defaults>::vmp_extract_selected_rows_default(module, res, a, first_row, row_step)
        }

        fn vmp_zero(module: &Module<Self>, res: &mut poulpy_hal::layouts::VmpPMatBackendMut<'_, Self>) {
            <Self as $defaults>::vmp_zero_default(module, res)
        }
    };
}
