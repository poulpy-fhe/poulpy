...
impl_glwe_automorphism_defaults_full!(NTT120Neon);

impl_ggsw_automorphism_defaults_full!(FFT64Neon);
impl_ggsw_automorphism_defaults_full!(NTT120Neon);
impl_gglwe_automorphism_defaults_full!(FFT64Neon);
impl_gglwe_automorphism_defaults_full!(NTT120Neon);

impl_decryption_defaults_full!(FFT64Neon);
impl_decryption_defaults_full!(NTT120Neon);
impl_glwe_trace_defaults_full!(FFT64Neon);
impl_glwe_trace_defaults_full!(NTT120Neon);
impl_glwe_packing_defaults_full!(FFT64Neon);
impl_glwe_packing_defaults_full!(NTT120Neon);

impl_conversion_defaults_full!(FFT64Neon);
impl_conversion_defaults_full!(NTT120Neon);

impl_glwe_keyswitch_defaults_full!(FFT64Neon);
impl_glwe_keyswitch_defaults_full!(NTT120Neon);
impl_gglwe_keyswitch_defaults_full!(FFT64Neon);
impl_gglwe_keyswitch_defaults_full!(NTT120Neon);
impl_ggsw_keyswitch_defaults_full!(FFT64Neon);
impl_ggsw_keyswitch_defaults_full!(NTT120Neon);
impl_lwe_keyswitch_defaults_full!(FFT64Neon);
impl_lwe_keyswitch_defaults_full!(NTT120Neon);

impl_encryption_defaults_full!(FFT64Neon);
impl_encryption_defaults_full!(NTT120Neon);

impl_glwe_external_product_defaults_full!(FFT64Neon);
impl_glwe_external_product_defaults_full!(NTT120Neon);
impl_gglwe_external_product_defaults_full!(FFT64Neon);
impl_gglwe_external_product_defaults_full!(NTT120Neon);
impl_ggsw_external_product_defaults_full!(FFT64Neon);
impl_ggsw_external_product_defaults_full!(NTT120Neon);

impl_linear_transformation_defaults_full!(FFT64Neon);
impl_linear_transformation_defaults_full!(NTT120Neon);
