...
poulpy_cpu_portable::impl_sampling_host!(FFT64Neon, fft64);
impl_encryption_defaults_full!(NTT4x30Neon);
poulpy_cpu_portable::impl_sampling_host!(NTT4x30Neon, ntt4x30);
...
mod rayon_defaults {
    ...
    poulpy_cpu_portable::impl_sampling_host!(FFT64NeonRayon, fft64);
    poulpy_cpu_portable::impl_sampling_host!(NTT4x30NeonRayon, ntt4x30);
}
