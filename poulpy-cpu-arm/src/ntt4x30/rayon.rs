...
impl const poulpy_hal::layouts::BackendMaxBase2k for NTT4x30NeonRayon {
    fn max_base2k(n: usize, products: usize, failure_bits: usize) -> Option<usize> {
        <NTT4x30Neon as poulpy_hal::layouts::BackendMaxBase2k>::max_base2k(n, products, failure_bits)
    }
}
