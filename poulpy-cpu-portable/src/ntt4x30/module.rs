//! Backend handle and module initialisation for [`NTT4x30Portable`](crate::NTT4x30Portable).
//!
//! This module defines:
//!
//! - [`NTT4x30PortableHandle`]: the opaque handle stored inside a `Module<NTT4x30Portable>`,
...
//!   inside the `Module`.
//! - The [`NttHandleProvider`] impl for [`NTT4x30PortableHandle`], wiring the handle into
...
/// Opaque handle for the [`NTT4x30Portable`](crate::NTT4x30Portable) backend.
///
...
/// `Module<NTT4x30Portable>` is dropped (via [`Backend::destroy`]).
#[repr(C)]
pub struct NTT4x30PortableHandle {
...
impl poulpy_hal::execution::ScratchWorkers for NTT4x30Portable {}

impl Backend for NTT4x30Portable {
    ...
    type Handle = NTT4x30PortableHandle;
    type Location = Host;
...
unsafe impl NttHandleFactory for NTT4x30PortableHandle {
...
unsafe impl NttHandleProvider for NTT4x30PortableHandle {
...
unsafe impl crate::table_cache::ModuleTableCacheProvider for NTT4x30PortableHandle {
