//! Single ring element (`Z[X]/(X^n+1)`) arithmetic for [`NTT4x30Portable`](crate::NTT4x30Portable).
//!
...
impl ZnxAdd for NTT4x30Portable {
    #[inline(always)]
...
impl ZnxAddAssign for NTT4x30Portable {
    #[inline(always)]
...
impl ZnxSub for NTT4x30Portable {
    #[inline(always)]
...
impl ZnxSubAssign for NTT4x30Portable {
    #[inline(always)]
...
impl ZnxSubNegateAssign for NTT4x30Portable {
    #[inline(always)]
...
impl ZnxMulAddPowerOfTwo for NTT4x30Portable {
    #[inline(always)]
...
impl ZnxMulPowerOfTwo for NTT4x30Portable {
    #[inline(always)]
...
impl ZnxMulPowerOfTwoAssign for NTT4x30Portable {
    #[inline(always)]
...
impl ZnxAutomorphism for NTT4x30Portable {
    #[inline(always)]
...
impl ZnxAutomorphismRotate for NTT4x30Portable {
    #[inline(always)]
...
impl ZnxCopy for NTT4x30Portable {
    #[inline(always)]
...
impl ZnxNegate for NTT4x30Portable {
    #[inline(always)]
...
impl ZnxNegateAssign for NTT4x30Portable {
    #[inline(always)]
...
impl ZnxRotate for NTT4x30Portable {
    #[inline(always)]
...
impl ZnxZero for NTT4x30Portable {
    #[inline(always)]
...
impl ZnxSwitchRing for NTT4x30Portable {
    #[inline(always)]
...
impl ZnxNormalizeFirstStep for NTT4x30Portable {
    #[inline(always)]
...
impl ZnxNormalizeMiddleStep for NTT4x30Portable {
    #[inline(always)]
...
impl ZnxNormalizeFinalStep for NTT4x30Portable {
    #[inline(always)]
...
impl ZnxNormalizeFinalStepAssign for NTT4x30Portable {
    #[inline(always)]
...
impl ZnxNormalizeFirstStepCarryOnly for NTT4x30Portable {
    #[inline(always)]
...
impl ZnxNormalizeFirstStepAssign for NTT4x30Portable {
    #[inline(always)]
...
impl ZnxNormalizeMiddleStepCarryOnly for NTT4x30Portable {
    #[inline(always)]
...
impl ZnxNormalizeMiddleStepAssign for NTT4x30Portable {
    #[inline(always)]
...
impl ZnxExtractDigitAddMul for NTT4x30Portable {
    #[inline(always)]
...
impl crate::reference::normalization::I64NormalizeOps for NTT4x30Portable {}

impl ZnxNormalizeDigit for NTT4x30Portable {
    #[inline(always)]
