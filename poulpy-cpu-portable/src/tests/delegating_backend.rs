...
use crate::{FFT64Portable, hal_impl::delegating_backend::DelegatingFFT64Portable};
...
fn sample_glwe() -> GLWE<Vec<u8>, i64> {
    ...
    let module: Module<FFT64Portable> = Module::new(256);
...
fn delegating_backend_manual_family_matches_fft64_ref() {
    let module_delegating: Module<DelegatingFFT64Portable> = Module::new(256);
    let module_ref: Module<FFT64Portable> = Module::new(256);
