...
#[inline(always)]
fn fill_fft2_omegas<R: Float + FloatConst>(
    j: R,
    omg: &mut [R],
    pos: usize,
...
#[inline(always)]
fn fill_fft4_omegas<R: Float + FloatConst>(
    j: R,
    omg: &mut [R],
    pos: usize,
    sin: impl Fn(R) -> R + Copy,
...
#[inline(always)]
fn fill_fft8_omegas<R: Float + FloatConst>(
    j: R,
    omg: &mut [R],
    pos: usize,
    sin: impl Fn(R) -> R + Copy,
...
#[inline(always)]
fn fill_fft16_omegas<R: Float + FloatConst>(
    j: R,
    omg: &mut [R],
    pos: usize,
    sin: impl Fn(R) -> R + Copy,
