...
//! # Scalar layout
//!
//! `VecZnxDft<_, NTT4x30Portable>` stores [`Q120bScalar`] values (32 bytes each).
...
/// [`NttHandleProvider`].  Backend crates (e.g. `poulpy-cpu-portable`) implement
...
/// metadata.
///
/// Implement this trait for your concrete handle struct (e.g. `NTT4x30PortableHandle`)
