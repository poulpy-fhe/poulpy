//! Backend handle and module initialization for [`FFT64Portable`](crate::FFT64Portable).
//!
//! This module defines:
//!
...
/// Opaque handle for the [`FFT64Portable`](crate::FFT64Portable) backend.
///
...
/// `Module<FFT64Portable>` is dropped (via [`Backend::destroy`]).
#[repr(C)]
pub struct FFT64PortableHandle {
    ring_plans: FFT64PlanSet<f64>,
    table_cache: crate::table_cache::ModuleTableCache,
}

impl poulpy_hal::execution::ScratchWorkers for FFT64Portable {}

impl Backend for FFT64Portable {
    ...
    type Handle = FFT64PortableHandle;
    type Location = Host;
...
unsafe impl FFT64HandleFactory for FFT64PortableHandle {
...
unsafe impl FFTHandleProvider<f64> for FFT64PortableHandle {
    fn get_fft_plan(&self, n: usize) -> &FFT64Plan<f64> {
        self.ring_plans.for_ring(n)
    }
}

unsafe impl crate::table_cache::ModuleTableCacheProvider for FFT64PortableHandle {
