//! Single ring element (`Z[X]/(X^n+1)`) arithmetic for [`FFT64Portable`](crate::FFT64Portable).
//!
...
impl ZnxAddAssign for FFT64Portable {
    #[inline(always)]
...
impl ZnxSubAssign for FFT64Portable {
    #[inline(always)]
...
impl ZnxSubNegateAssign for FFT64Portable {
    #[inline(always)]
...
impl ZnxMulAddPowerOfTwo for FFT64Portable {
    #[inline(always)]
...
impl ZnxMulPowerOfTwo for FFT64Portable {
    #[inline(always)]
...
impl ZnxMulPowerOfTwoAssign for FFT64Portable {
    #[inline(always)]
...
impl ZnxAutomorphism for FFT64Portable {
    #[inline(always)]
...
impl ZnxAutomorphismRotate for FFT64Portable {
    #[inline(always)]
...
impl ZnxCopy for FFT64Portable {
    #[inline(always)]
...
impl ZnxNegate for FFT64Portable {
    #[inline(always)]
...
impl ZnxNegateAssign for FFT64Portable {
    #[inline(always)]
...
impl ZnxRotate for FFT64Portable {
    #[inline(always)]
...
impl ZnxZero for FFT64Portable {
    #[inline(always)]
...
impl ZnxSwitchRing for FFT64Portable {
    #[inline(always)]
...
impl ZnxNormalizeFirstStep for FFT64Portable {
    #[inline(always)]
...
impl ZnxNormalizeMiddleStep for FFT64Portable {
    #[inline(always)]
...
impl ZnxNormalizeFinalStep for FFT64Portable {
    #[inline(always)]
...
impl ZnxNormalizeFinalStepAssign for FFT64Portable {
    #[inline(always)]
...
impl ZnxNormalizeFirstStepCarryOnly for FFT64Portable {
    #[inline(always)]
...
impl ZnxNormalizeFirstStepAssign for FFT64Portable {
    #[inline(always)]
...
impl ZnxNormalizeMiddleStepCarryOnly for FFT64Portable {
    #[inline(always)]
...
impl ZnxNormalizeMiddleStepAssign for FFT64Portable {
    #[inline(always)]
...
impl ZnxExtractDigitAddMul for FFT64Portable {
    #[inline(always)]
...
impl crate::reference::normalization::I64NormalizeOps for FFT64Portable {}

impl ZnxNormalizeDigit for FFT64Portable {
    #[inline(always)]
...
mod normalization_tests {
    ...
    fn test_normalization_kernels_bounded_inputs() {
        crate::test_suite::normalization::test_normalization_kernels::<crate::FFT64Portable>();
        crate::test_suite::normalization::test_normalization_kernels::<crate::NTT4x30Portable>();
    }
}
