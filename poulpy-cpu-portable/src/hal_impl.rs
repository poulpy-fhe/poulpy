...
unsafe impl HalVecZnxImpl for FFT64Portable {
    hal_impl_vec_znx!();
}

unsafe impl HalModuleImpl for FFT64Portable {
    hal_impl_module!(FFT64ModuleDefault);
}

unsafe impl HalVmpImpl for FFT64Portable {
    hal_impl_vmp!(FFT64VmpDefault);
}

unsafe impl HalConvolutionImpl for FFT64Portable {
    hal_impl_convolution!(FFT64ConvolutionDefault);
}

unsafe impl HalVecZnxBigImpl for FFT64Portable {
    hal_impl_vec_znx_big!(FFT64VecZnxBigDefault);
}

unsafe impl HalSvpImpl for FFT64Portable {
    hal_impl_svp!(FFT64SvpDefault);
}

unsafe impl HalVecZnxDftImpl for FFT64Portable {
    hal_impl_vec_znx_dft!(FFT64VecZnxDftDefault);
}

unsafe impl HalVecZnxImpl for NTT4x30Portable {
    hal_impl_vec_znx!();
}

unsafe impl HalModuleImpl for NTT4x30Portable {
    hal_impl_module!(NTT4x30ModuleDefault);
}

unsafe impl HalVmpImpl for NTT4x30Portable {
    hal_impl_vmp!(NTT4x30VmpDefault);
}

unsafe impl HalConvolutionImpl for NTT4x30Portable {
...
unsafe impl HalVecZnxBigImpl for NTT4x30Portable {
    hal_impl_vec_znx_big!(NTT4x30VecZnxBigDefault);
}

unsafe impl HalSvpImpl for NTT4x30Portable {
    hal_impl_svp!(NTT4x30SvpDefault);
}

unsafe impl HalVecZnxDftImpl for NTT4x30Portable {
