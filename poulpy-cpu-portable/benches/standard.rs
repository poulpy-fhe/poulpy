...
//! implementation; this binary just wires it up against `poulpy-cpu-portable`'s
//! backends.
//!
...
use poulpy_cpu_portable::FFT64Portable as Fft;
use poulpy_cpu_portable::NTT4x30Portable as Ntt;
