...
use poulpy_cpu_portable::{
    FFT64ReimTable, NTT4x30Portable,
...
fn main() {
    ...
    let module = Module::<NTT4x30Portable>::new(params.n as u64);
    let host_module = Module::<HostBytesBackend>::new(params.n as u64);

    test_bootstrapping_standard_e2e::<NTT4x30Portable, f64, FFT64ReimTable<f64>>(params, &module, &host_module);
}
