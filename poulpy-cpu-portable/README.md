...
The FFT64 and NTT4x30 portable HAL backends are always available and require
...
- `enable-core` wires the portable backends into `poulpy-core` defaults.
- `enable-ckks` wires the portable backends into `poulpy-ckks` defaults and
  also enables core support.

Useful test commands:

```sh
# HAL/portable backend tests
