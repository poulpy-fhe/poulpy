...
use poulpy_hal::{
    ...
    layouts::{Backend, DataView, GaloisElement, HostDataMut, HostDataRef, Module, ScratchOwned, VecZnx, ZnxViewMut},
    source::Source,
...
use crate::{
    ...
    layouts::{
        ...
        GLWESecretPreparedFactory, GLWEToBackendMut, GLWEToBackendRef, GetAutomorphismKey, LWEInfos, ModuleCoreAlloc,
        TorusPrecision,
        prepared::{
    ...
    ScratchOwned<BE>: ScratchOwnedAlloc<BE> + ScratchOwnedBorrow<BE>,
{
    ...
    for coarse_ps in coarse_sets {
        ...
        module.glwe_prepare_linear_transformation_baby_steps(&mut dirty_babies, &ct_dirty, &keys, &mut prep_scratch.borrow());
