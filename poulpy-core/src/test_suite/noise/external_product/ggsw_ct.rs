    ...
    ScratchOwned<BE>: ScratchOwnedAlloc<BE> + ScratchOwnedBorrow<BE>,
{
    ...
    for rank in 1_usize..3 {
        for dsize in 1..max_dsize + 1 {
            ...
            let mut pt_in: ScalarZnx<BE::OwnedBuf, BE::ZnxWord> = module.scalar_znx_alloc(module.n(), 1);
            let mut pt_apply: ScalarZnx<BE::OwnedBuf, BE::ZnxWord> = module.scalar_znx_alloc(module.n(), 1);
            ...
            module.ggsw_external_product(
                &mut ggsw_out,
                &ggsw_in,
                &ct_rhs_prepared.to_backend_ref(),
                &mut scratch.borrow(),
            );
    ...
    ScratchOwned<BE>: ScratchOwnedAlloc<BE> + ScratchOwnedBorrow<BE>,
{
    ...
    for rank in 1_usize..3 {
        for dsize in 1..max_dsize + 1 {
            ...
            module.ggsw_external_product_assign(&mut ggsw_out, &ct_rhs_prepared.to_backend_ref(), &mut scratch.borrow());
