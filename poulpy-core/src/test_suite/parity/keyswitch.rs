...
pub fn test_glwe_keyswitch_parity<BR, BT>(
    ...
    Module<BR>: GLWEKeyswitch<BR> + GGLWEPreparedFactory<BR> + GLWEMaskFill<BR> + VecZnxFillUniformSource<BR>,
...
pub fn test_gglwe_keyswitch_parity<BR, BT>(
    ...
    BT: ParityBackend,
    BR::OwnedBuf: HostDataMut,
    Module<BR>: GGLWEKeyswitch<BR> + GGLWEPreparedFactory<BR> + GLWEMaskFill<BR> + VecZnxFillUniformSource<BR>,
