use poulpy_hal::{
    layouts::{Backend, CoeffNormalized, Data, Module, ScratchArena},
...
pub unsafe trait DecryptionImpl<BE: Backend>: Backend {
    ...
    fn glwe_tensor_decrypt<R: Data, P: Data, S0: Data, S1: Data>(
        ...
        GLWEPlaintext<P, BE::ZnxWord>: GLWEToBackendMut<BE, State = CoeffNormalized> + GLWEInfos + SetBase2k,
    ...
    ($be:ty) => {
        impl $crate::oep::DecryptionDefault<$be> for ::poulpy_hal::layouts::Module<$be> {
            ...
            fn glwe_decrypt_default<R, P, S>(
                ...
                R: $crate::layouts::GLWEToBackendRef<$be, State = ::poulpy_hal::layouts::CoeffNormalized> + $crate::layouts::GLWEInfos,
                P: $crate::layouts::GLWEToBackendMut<$be, State = ::poulpy_hal::layouts::CoeffNormalized> + $crate::layouts::GLWEInfos + $crate::layouts::SetBase2k,
            ...
            fn lwe_matrix_decrypt_default<R, P, S>(
                ...
                P: $crate::layouts::GLWEToBackendMut<$be, State = ::poulpy_hal::layouts::CoeffNormalized> + $crate::layouts::SetBase2k + $crate::layouts::GLWEInfos,
                S: $crate::layouts::LWESecretToBackendRef<$be> + $crate::layouts::LWEInfos,
            {
            ...
            >(
                ...
                $crate::layouts::GLWETensor<R, <$be as poulpy_hal::layouts::Backend>::ZnxWord>:
                    $crate::layouts::GLWEToBackendRef<$be, State = ::poulpy_hal::layouts::CoeffNormalized> + $crate::layouts::GLWEInfos,
                $crate::layouts::GLWEPlaintext<P, <$be as poulpy_hal::layouts::Backend>::ZnxWord>:
                    $crate::layouts::GLWEToBackendMut<$be, State = ::poulpy_hal::layouts::CoeffNormalized>
