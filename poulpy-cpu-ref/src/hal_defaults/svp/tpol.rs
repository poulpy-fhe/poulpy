//! Reference kernels whose prepared operand is the transformed hot-prep [`SvpTPol`](poulpy_hal::layouts::SvpTPol).
...
use poulpy_hal::{
    api::VecZnxDftApply,
    layouts::{
        Backend, HostDataMut, HostDataRef, Module, ScalarZnxBackendRef, SvpTPolBackendMut, SvpTPolBackendRef, VecZnxBackendRef,
        VecZnxDftBackendMut, VecZnxDftBackendRef, VecZnxDftToBackendMut, VecZnxDftToBackendRef, ZnxView, ZnxViewMut,
    },
};

#[doc(hidden)]
pub trait FFT64SvpTPolDefault<BE: Backend<ZnxWord = i64>>: Backend {
...
impl<BE: Backend<ZnxWord = i64>> FFT64SvpTPolDefault<BE> for BE where BE::OwnedBuf: HostDataMut {}

#[doc(hidden)]
pub trait NTT4x30SvpTPolDefault<BE: Backend<ZnxWord = i64>>: Backend {
    fn svp_prepare_tpol_default(
        module: &Module<BE>,
        res: &mut SvpTPolBackendMut<'_, BE>,
        res_col: usize,
...
impl<BE: Backend<ZnxWord = i64>> NTT4x30SvpTPolDefault<BE> for BE where BE::OwnedBuf: HostDataMut {}
