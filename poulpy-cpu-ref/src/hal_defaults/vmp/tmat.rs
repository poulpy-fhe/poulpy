//! Reference kernels whose prepared operand is the transformed hot-prep [`VmpTMat`](poulpy_hal::layouts::VmpTMat).
...
#[doc(hidden)]
pub trait FFT64VmpTMatDefault<BE: Backend<ZnxWord = i64>>: Backend {
    #[allow(clippy::too_many_arguments)]
    fn vmp_prepare_tmat_tmp_bytes_default(
        module: &Module<BE>,
        rows: usize,
        cols_in: usize,
        cols_out: usize,
        ...
        fft64_vmp::vmp_prepare_tmat_tmp_bytes(module.n())
    }
    #[allow(clippy::too_many_arguments)]
    fn vmp_prepare_tmat_default(
        module: &Module<BE>,
    ...
    #[allow(clippy::too_many_arguments)]
    fn vmp_apply_tmat_dft_to_dft_default(
        _module: &Module<BE>,
        res: &mut VecZnxDftBackendMut<'_, BE>,
        a: &VmpTMatBackendRef<'_, BE>,
        ...
        for<'x> BE::BufRef<'x>: HostDataRef,
    {
        ...
        let (tmp, _) = take_host_typed::<BE, f64>(scratch.borrow(), bytes / size_of::<f64>());
        fft64_vmp::vmp_apply_tmat_dft_to_dft::<true, BE>(res, a, b, limb_offset, tmp);
    }
    #[allow(clippy::too_many_arguments)]
    fn vmp_apply_tmat_dft_to_dft_accumulate_tmp_bytes_default(
        module: &Module<BE>,
        res_size: usize,
        a_rows: usize,
        a_cols_in: usize,
        ...
        module.bytes_of_vec_znx_dft(a_cols_out, res_size)
            + Self::vmp_apply_tmat_dft_to_dft_tmp_bytes_default(module, res_size, a_rows, a_cols_in, a_cols_out, a_size, b_size)
    }
    ...
    #[allow(clippy::too_many_arguments)]
    fn vmp_apply_tmat_dft_to_dft_accumulate_default(
        module: &Module<BE>,
        res: &mut VecZnxDftBackendMut<'_, BE>,
        a: &VmpTMatBackendRef<'_, BE>,
        b: &VecZnxDftBackendRef<'_, BE>,
        ...
        for<'x> BE::BufRef<'x>: HostDataRef,
    {
        ...
        Self::vmp_apply_tmat_dft_to_dft_default(module, &mut tmp.to_backend_mut(), a, b, limb_offset, &mut scratch_1);
...
impl<BE: Backend<ZnxWord = i64>> FFT64VmpTMatDefault<BE> for BE {}

#[doc(hidden)]
pub trait NTT4x30VmpTMatDefault<BE: Backend<ZnxWord = i64>>: Backend {
    #[allow(clippy::too_many_arguments)]
    fn vmp_prepare_tmat_tmp_bytes_default(
        module: &Module<BE>,
        rows: usize,
        ...
        let _ = (rows, cols_in, cols_out, size);
        ntt4x30_vmp::ntt4x30_vmp_prepare_tmat_tmp_bytes(module.n())
    }
    #[allow(clippy::too_many_arguments)]
    fn vmp_prepare_tmat_default(
        module: &Module<BE>,
        ...
        for<'x> BE::BufRef<'x>: HostDataRef,
    {
        ...
        let (tmp, _) = take_host_typed::<BE, u64>(scratch.borrow(), bytes / size_of::<u64>());
        ntt4x30_vmp::ntt4x30_vmp_apply_tmat_dft_to_dft::<BE>(module, res, a, b, limb_offset, tmp);
    }
    #[allow(clippy::too_many_arguments)]
    fn vmp_apply_tmat_dft_to_dft_accumulate_tmp_bytes_default(
        module: &Module<BE>,
...
impl<BE: Backend<ZnxWord = i64>> NTT4x30VmpTMatDefault<BE> for BE {}
