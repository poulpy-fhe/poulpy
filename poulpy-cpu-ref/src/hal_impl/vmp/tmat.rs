//! `tmat` tier of the VMP backend implementation.
//!
//! Expanded inside a backend's `HalVmpTmatImpl` block.

/// Emits every `tmat`-tier method: the kernel forwarders, then the variants
/// derived from them.
#[macro_export]
macro_rules! hal_impl_vmp_tmat {
    ($defaults:ident) => {
        #[allow(clippy::too_many_arguments)]
        fn vmp_apply_tmat_dft_to_dft_accumulate(
            module: &Module<Self>,
            res: &mut poulpy_hal::layouts::VecZnxDftBackendMut<'_, Self>,
            a: &poulpy_hal::layouts::VmpTMatBackendRef<'_, Self>,
            b: &poulpy_hal::layouts::VecZnxDftBackendRef<'_, Self>,
            limb_offset: usize,
            scratch: &mut poulpy_hal::layouts::ScratchArena<'_, Self>,
        ) {
            <Self as $defaults<Self>>::vmp_apply_tmat_dft_to_dft_accumulate_default(module, res, a, b, limb_offset, scratch)
        }
        ...
        fn vmp_apply_tmat_dft_to_dft_accumulate_tmp_bytes(
            ...
            <Self as $defaults<Self>>::vmp_apply_tmat_dft_to_dft_accumulate_tmp_bytes_default(
        ...
        fn vmp_apply_tmat_dft_to_dft(
            ...
            <Self as $defaults<Self>>::vmp_apply_tmat_dft_to_dft_default(module, res, a, b, limb_offset, scratch)
        }
        ...
        fn vmp_apply_tmat_dft_to_dft_tmp_bytes(
            ...
            <Self as $defaults<Self>>::vmp_apply_tmat_dft_to_dft_tmp_bytes_default(
                module, res_size, a_rows, a_cols_in, a_cols_out, a_size, b_size,
            )
        }
        ...
        fn vmp_prepare_tmat(
            module: &Module<Self>,
            res: &mut poulpy_hal::layouts::VmpTMatBackendMut<'_, Self>,
            a: &poulpy_hal::layouts::MatZnxBackendRef<'_, Self>,
            scratch: &mut poulpy_hal::layouts::ScratchArena<'_, Self>,
        ) {
            <Self as $defaults<Self>>::vmp_prepare_tmat_default(module, res, a, scratch)
        }

        #[allow(clippy::too_many_arguments)]
        fn vmp_prepare_tmat_tmp_bytes(module: &Module<Self>, rows: usize, cols_in: usize, cols_out: usize, size: usize) -> usize {
            <Self as $defaults<Self>>::vmp_prepare_tmat_tmp_bytes_default(module, rows, cols_in, cols_out, size)
        }

        $crate::__hal_impl_vmp_tmat_derived!();
    };
...
#[doc(hidden)]
#[macro_export]
macro_rules! __hal_impl_vmp_tmat_derived {
    () => {
        #[allow(clippy::too_many_arguments)]
        fn vmp_apply_tmat_dft_to_small(
            ...
            Self::vmp_apply_tmat_dft_to_big(module, &mut tmp.to_backend_mut(), a, b, limb_offset, &mut scratch_1);
        ...
        fn vmp_apply_tmat_small_to_small(
            ...
            let (mut tmp, mut scratch_1) =
                poulpy_hal::api::ScratchArenaTakeBasic::take_vec_znx_big_scratch(scratch.borrow(), module, cols_out, res_size);
            Self::vmp_apply_tmat_small_to_big(module, &mut tmp.to_backend_mut(), a, b, &mut scratch_1);
            let tmp_ref = tmp.to_backend_ref();
            for col in 0..cols_out {
                module.vec_znx_big_normalize(
                    res,
        ...
        fn vmp_apply_tmat_dft_to_big(
            ...
            Self::vmp_apply_tmat_dft_to_dft(module, &mut tmp.to_backend_mut(), a, b, limb_offset, &mut scratch_1);
            for col in 0..cols_out {
        ...
        fn vmp_apply_tmat_small_to_big(
            ...
            let (mut tmp, mut scratch_1) =
                poulpy_hal::api::ScratchArenaTakeBasic::take_vec_znx_dft_scratch(scratch.borrow(), module, cols_out, res_size);
            Self::vmp_apply_tmat_small_to_dft(module, &mut tmp.to_backend_mut(), a, b, &mut scratch_1);
            for col in 0..cols_out {
                module.vec_znx_idft_apply_tmpa(res, col, &mut tmp.to_backend_mut(), col);
            }
        }
        ...
        fn vmp_apply_tmat_small_to_dft(
            ...
            Self::vmp_apply_tmat_dft_to_dft(module, res, a, &b_dft.to_backend_ref(), 0, &mut scratch_1);
        }
        ...
        fn vmp_apply_tmat_small_to_dft_tmp_bytes(
            ...
            module.bytes_of_vec_znx_dft(a_cols_in, dft_size)
                + Self::vmp_apply_tmat_dft_to_dft_tmp_bytes(module, res_size, a_rows, a_cols_in, a_cols_out, a_size, dft_size)
        }
    };
}
