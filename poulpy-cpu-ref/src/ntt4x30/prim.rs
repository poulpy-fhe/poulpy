//! Trait implementations for [`NTT4x30Ref`] — primitive NTT-domain operations.
//!
//! Implements all `Ntt*` traits from [`crate::reference::ntt4x30`] for
//! [`NTT4x30Ref`], delegating to the `*_ref` scalar functions.
//!
...
impl NttDFTExecute<NttTable<Primes30, Ring>> for NTT4x30Ref {
    #[inline(always)]
...
impl NttDFTExecute<NttTableInv<Primes30, Ring>> for NTT4x30Ref {
    #[inline(always)]
