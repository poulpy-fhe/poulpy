...
impl ZnxAddAssign for NTT4x30Ref {
    #[inline(always)]
...
impl ZnxSubAssign for NTT4x30Ref {
    #[inline(always)]
...
impl ZnxSubNegateAssign for NTT4x30Ref {
    #[inline(always)]
...
impl ZnxMulAddPowerOfTwo for NTT4x30Ref {
    #[inline(always)]
...
impl ZnxMulPowerOfTwo for NTT4x30Ref {
    #[inline(always)]
...
impl ZnxMulPowerOfTwoAssign for NTT4x30Ref {
    #[inline(always)]
...
impl ZnxAutomorphism for NTT4x30Ref {
    #[inline(always)]
...
impl ZnxAutomorphismRotate for NTT4x30Ref {
    #[inline(always)]
...
impl ZnxNegateAssign for NTT4x30Ref {
    #[inline(always)]
...
impl ZnxSwitchRing for NTT4x30Ref {
    #[inline(always)]
...
impl ZnxNormalizeFirstStep for NTT4x30Ref {
    #[inline(always)]
...
impl ZnxNormalizeMiddleStep for NTT4x30Ref {
    #[inline(always)]
...
impl ZnxNormalizeFinalStep for NTT4x30Ref {
    #[inline(always)]
...
impl ZnxNormalizeFinalStepAssign for NTT4x30Ref {
    #[inline(always)]
...
impl ZnxNormalizeFirstStepCarryOnly for NTT4x30Ref {
    #[inline(always)]
...
impl ZnxNormalizeFirstStepAssign for NTT4x30Ref {
    #[inline(always)]
...
impl ZnxNormalizeMiddleStepCarryOnly for NTT4x30Ref {
    #[inline(always)]
...
impl ZnxNormalizeMiddleStepAssign for NTT4x30Ref {
    #[inline(always)]
