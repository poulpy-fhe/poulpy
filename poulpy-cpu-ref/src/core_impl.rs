...
impl_automorphism_reference_full!(FFT64Ref);
impl_automorphism_reference_full!(NTT4x30Ref);

impl_decryption_reference_full!(FFT64Ref);
impl_decryption_reference_full!(NTT4x30Ref);
impl_glwe_trace_derived_full!(FFT64Ref);
impl_glwe_trace_derived_full!(NTT4x30Ref);
impl_glwe_packing_derived_full!(FFT64Ref);
impl_glwe_packing_derived_full!(NTT4x30Ref);
...
impl_gglwe_keyswitch_derived_full!(FFT64Ref);
impl_gglwe_keyswitch_derived_full!(NTT4x30Ref);
impl_ggsw_keyswitch_derived_full!(FFT64Ref);
impl_ggsw_keyswitch_derived_full!(NTT4x30Ref);
...
poulpy_core::impl_polynomial_evaluation_derived_full!(FFT64Ref);
...
poulpy_core::impl_polynomial_evaluation_derived_full!(NTT4x30Ref);
...
impl_gglwe_external_product_derived_full!(FFT64Ref);
impl_gglwe_external_product_derived_full!(NTT4x30Ref);
impl_ggsw_external_product_derived_full!(FFT64Ref);
impl_ggsw_external_product_derived_full!(NTT4x30Ref);
