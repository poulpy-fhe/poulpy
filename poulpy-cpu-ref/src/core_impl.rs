...
impl_glwe_keyswitch_into_big_defaults_full!(FFT64Ref);
impl_glwe_keyswitch_into_big_defaults_full!(NTT4x30Ref);
impl_glwe_finalize_big_defaults_full!(FFT64Ref);
impl_glwe_finalize_big_defaults_full!(NTT4x30Ref);
