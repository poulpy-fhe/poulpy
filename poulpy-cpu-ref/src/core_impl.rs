...
impl_glwe_tensor_rank1_dft_default!(FFT64Ref);
impl_glwe_tensor_rank1_dft_default!(NTT4x30Ref);
impl_gglwe_product_digits_strided_default!(FFT64Ref);
impl_gglwe_product_digits_strided_default!(NTT4x30Ref);
