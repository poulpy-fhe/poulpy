...
macro_rules! impl_cpu_core_defaults {
    ($be:ty, $word_family:ident) => {
        ::poulpy_core::impl_glwe_automorphism_reference_full!($be);
        ::poulpy_core::impl_ggsw_automorphism_reference_full!($be);
        ::poulpy_core::impl_gglwe_automorphism_reference_full!($be);
        ::poulpy_core::impl_decryption_reference_full!($be);
        ::poulpy_core::impl_glwe_trace_reference_full!($be);
        ::poulpy_core::impl_glwe_packing_reference_full!($be);
        ::poulpy_core::impl_conversion_reference_full!($be);
        ::poulpy_core::impl_glwe_keyswitch_reference_full!($be);
        ::poulpy_core::impl_gglwe_keyswitch_reference_full!($be);
        ::poulpy_core::impl_ggsw_keyswitch_reference_full!($be);
        ...
        ::poulpy_core::impl_gglwe_external_product_reference_full!($be);
        ::poulpy_core::impl_ggsw_external_product_reference_full!($be);
