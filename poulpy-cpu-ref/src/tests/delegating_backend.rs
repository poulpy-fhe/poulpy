...
fn delegating_backend_manual_family_matches_fft64_ref() {
    const DELEGATED_RADIX: Option<usize> = Module::<DelegatingFFT64Ref>::max_base2k(256, 32, 128);
    assert_eq!(DELEGATED_RADIX, None);
    assert_eq!(DELEGATED_RADIX, Module::<FFT64Ref>::max_base2k(256, 32, 128));
