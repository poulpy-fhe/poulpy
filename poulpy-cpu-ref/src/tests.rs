...
use poulpy_hal::{
    ...
    test_suite::convolution::{
        ...
        test_convolution_pairwise, test_convolution_tensor_rank1,
    },
};
...
#[test]
fn test_convolution_tensor_rank1_fft64_ref() {
    let module: Module<FFT64Ref> = Module::<FFT64Ref>::new(8);
    test_convolution_tensor_rank1(&module, 17);
}
...
#[test]
fn test_convolution_tensor_rank1_ntt4x30_ref() {
    let module: Module<NTT4x30Ref> = Module::<NTT4x30Ref>::new(8);
