...
use super::vec_znx_big_avx::{
    ...
    vi128_add_small_avx2, vi128_from_small_avx2, vi128_hadamard_i64_avx2, vi128_neg_from_small_avx2, vi128_negate_assign_avx2,
    vi128_negate_avx2, vi128_sub_assign_avx2, vi128_sub_avx2, vi128_sub_negate_assign_avx2, vi128_sub_small_a_avx2,
    vi128_sub_small_assign_avx2, vi128_sub_small_b_avx2, vi128_sub_small_negate_assign_avx2,
};
use poulpy_cpu_ref::hal_defaults::BigWordHadamardProduct;
use poulpy_cpu_ref::reference::ntt4x30::{I128BigOps, I128NormalizeOps};

impl<R: CpuRing> I128BigOps for NTT4x30AvxBackend<R> {
    #[inline(always)]
...
impl<R: CpuRing> BigWordHadamardProduct for NTT4x30AvxBackend<R> {
    #[inline(always)]
...
impl<R: CpuRing> I128NormalizeOps for NTT4x30AvxBackend<R> {
    #[inline(always)]
