//! AVX2-accelerated NTT4x30 CPU backend for the Poulpy lattice cryptography library.
//!
...
/// AVX2-accelerated NTT4x30 CPU backend for Poulpy HAL.
///
/// `NTT4x30Avx` is a zero-sized marker type that selects the AVX2-accelerated NTT4x30 backend
