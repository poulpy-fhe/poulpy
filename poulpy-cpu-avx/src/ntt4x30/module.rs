//! Backend handle and module initialisation for [`NTT4x30Avx`](super::NTT4x30Avx).
//!
//! This module defines:
//!
//! - [`NTT4x30AvxHandle`]: the opaque handle stored inside a `Module<NTT4x30Avx>`,
...
/// Opaque handle for the [`NTT4x30Avx`](super::NTT4x30Avx) backend.
///
...
impl poulpy_hal::layouts::BackendMaxBase2k for NTT4x30Avx {
