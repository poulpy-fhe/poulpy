...
poulpy_cpu_portable::impl_sampling_host!(FFT64Avx, fft64);
impl_encryption_defaults_full!(NTT4x30Avx);
poulpy_cpu_portable::impl_sampling_host!(NTT4x30Avx, ntt4x30);
...
mod rayon_defaults {
    ...
    poulpy_cpu_portable::impl_sampling_host!(FFT64AvxRayon, fft64);
    ...
    poulpy_cpu_portable::impl_sampling_host!(NTT4x30AvxRayon, ntt4x30);
