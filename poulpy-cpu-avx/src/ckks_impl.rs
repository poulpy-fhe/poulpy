...
use poulpy_ckks::{
    ...
    impl_ckks_dft_defaults, impl_ckks_encryption_defaults, impl_ckks_imag_defaults, impl_ckks_maintain_ops_defaults,
    impl_ckks_mul_defaults, impl_ckks_neg_defaults, impl_ckks_plaintext_defaults, impl_ckks_pow2_defaults,
    impl_ckks_rescale_defaults, impl_ckks_rotate_default, impl_ckks_sub_defaults,
};
...
impl_ckks_add_defaults!(NTT120Avx);
impl_ckks_sub_defaults!(FFT64Avx);
impl_ckks_sub_defaults!(NTT120Avx);
impl_ckks_plaintext_defaults!(FFT64Avx);
impl_ckks_plaintext_defaults!(NTT120Avx);
impl_ckks_maintain_ops_defaults!(FFT64Avx);
impl_ckks_maintain_ops_defaults!(NTT120Avx);
impl_ckks_dft_defaults!(FFT64Avx);
impl_ckks_dft_defaults!(NTT120Avx);
impl_ckks_bootstrapping_defaults!(FFT64Avx);
impl_ckks_bootstrapping_defaults!(NTT120Avx);
