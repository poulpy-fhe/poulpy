...
impl_ckks_eval_mod_defaults!(FFT64Avx);
impl_ckks_eval_mod_defaults!(NTT4x30Avx);
impl_ckks_bootstrap_defaults!(FFT64Avx);
impl_ckks_bootstrap_defaults!(NTT4x30Avx);
