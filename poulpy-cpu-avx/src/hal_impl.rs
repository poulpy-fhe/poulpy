...
unsafe impl HalVmpImpl for NTT4x30Avx {
    ...
    fn vmp_apply_dft_to_dft(
        ...
        let (tmp, _) = take_host_typed::<Self, u64>(scratch.borrow(), bytes / size_of::<u64>());
        super::ntt4x30::vmp::vmp_apply_dft_to_dft_avx::<poulpy_hal::execution::SerialTaskExecutor>(
            module,
            res,
            a,
            b,
    ...
    fn vmp_apply_dft_to_dft_add(
        ...
        let bytes = super::ntt4x30::vmp::vmp_apply_tmp_bytes_avx(a.size(), b.rows(), b.cols_in());
        let (tmp, _) = take_host_typed::<Self, u64>(scratch.borrow(), bytes / size_of::<u64>());
        super::ntt4x30::vmp::vmp_apply_dft_to_dft_add_avx::<poulpy_hal::execution::SerialTaskExecutor>(
            module,
            res,
            a,
            b,
...
unsafe impl HalVecZnxDftImpl for NTT4x30Avx {
    ...
    fn vec_znx_dft_automorphism_add_with_plan(
        ...
        let _ = scratch;
        let _ = module;
        super::ntt4x30::vec_znx_dft::vec_znx_dft_automorphism_add::<SerialTaskExecutor>(plan, res, res_col, a, a_col)
    }
}
