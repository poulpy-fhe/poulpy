...
impl poulpy_cpu_portable::reference::normalization::I64NormalizeOps for FFT64Avx {
    #[inline(always)]
...
unsafe impl ::poulpy_cpu_portable::table_cache::ModuleTableCacheProvider for FFT64AvxHandle {
